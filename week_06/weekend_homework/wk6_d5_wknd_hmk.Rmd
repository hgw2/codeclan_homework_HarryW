...
H0 = the proportion of clicks on a minus the proportion of clicks on b is equal to 0
Ha the proportion of clicks on a minus the proportion of clicks on be os less than 0
...
rules<-apriori(data=apriori_format, parameter=list(supp=0.001,conf = 0.15), 
               appearance = list(default="rhs",lhs="HAND WARMER UNION JACK"),
