...
```
# Extension 
Using bboxfinder I was able to find the coordinents for the continent and create a case when which took   the latitude and longitude from the meteorite findings and categorized this into their continents. I then used this information to create a function to show this information 
```{r}

source("functions/show_continent_function.R")

show_continent(27.05000, -105.43333)
